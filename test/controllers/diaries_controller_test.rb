...
class DiariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diary" do
    assert_difference('Diary.count') do
      post diaries_url, params: { diary: { diary_body: @diary.diary_body, diary_image_id: @diary.diary_image_id, diary_title: @diary.diary_title, user_id: @diary.user_id } }
    end
  ...
  test "should update diary" do
    patch diary_url(@diary), params: { diary: { diary_body: @diary.diary_body, diary_image_id: @diary.diary_image_id, diary_title: @diary.diary_title, user_id: @diary.user_id } }
